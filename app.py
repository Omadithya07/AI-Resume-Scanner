...
rf_classifier_categorization = pickle.load(open(r'C:\Users\omadi\Desktop\Resume Scanner\models\rf_classifier_categorization.pkl', 'rb'))
tfidf_vectorizer_categorization = pickle.load(open(r'C:\Users\omadi\Desktop\Resume Scanner\models\tfidf_vectorizer_categorization.pkl', 'rb'))
rf_classifier_job_recommendation = pickle.load(open(r'C:\Users\omadi\Desktop\Resume Scanner\models\rf_classifier_job_recommendation.pkl', 'rb'))
tfidf_vectorizer_job_recommendation = pickle.load(open(r'C:\Users\omadi\Desktop\Resume Scanner\models\tfidf_vectorizer_job_recommendation.pkl', 'rb'))
